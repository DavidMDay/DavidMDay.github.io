...
\author{Maximillian Julius Otto Strutt}
\address{Naturkundig Laboratorium der N. V. Philips' Gloeilampenfabrieken, Eindhoven/Holland}
\date{May 18 1933}
\begin{document}
\maketitle

\noindent
\textbf{Translator's Note:} This document is an open-source English translation 
created by David M. Day. The original text was published in German by 
Maximillian Strutt in 1933 \autocite{Strutt1933}.
This translation is hosted publicly on GitHub for research and educational purposes.
...
method is from Lord Rayleigh.~\autocite{Rayleigh1881}~\autocite[\S 235 f]{RayleighSoundVol1Ed2}
%~\autocite[page 551]{ScientificPapersVol1}
...
shell~\autocite[page~603]{LoveEd4} are so complex that no attempt has been
made to calculate the natural frequencies based on these equations.  In
contrast, the calculation using Rayleigh's method~\autocite{ScientificPapersVol1} for a
...
those obtained by Lord Rayleigh \autocite[p 399 Eq 14]{RayleighSoundVol1Ed2}
...
Lord Rayleigh's formulas \autocite[p 414 Eq 6]{RayleighSoundVol1Ed2}.
...
\]
where \(\rho\) is the density.  Assuming temporal variation of \(u,v,w\) of \(\cos \omega t\):
...
\]
a well-known formula \autocite[p 417 Eq 18]{RayleighSoundVol1Ed2}.
